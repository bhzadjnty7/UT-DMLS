#!/usr/bin/env python3
"""
Benchmark: Matrix Inverse Computation (20000x20000)
DMLS - CA1 - Part 3.2

This script benchmarks matrix inversion for a large square matrix.
Note: This requires significant memory (approximately 6.4 GB).
"""
import numpy as np
import time
import os
...
def benchmark_inverse(size=20000, n_runs=3):
    """
...
if __name__ == "__main__":
    ...
    required_memory = 2 * size * size * 8 / (1024**3)  # Need space for A and A_inv
